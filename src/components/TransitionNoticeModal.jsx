  ...
  return (
    <div className="transition-notice-overlay">
      <div className="transition-notice">
        ...
        <h2>La Quiniela RH ya terminó</h2>
        ...
        <p>A partir de ahora, la plataforma continúa con una nueva quiniela para quienes quieran seguir pronosticando los siguientes partidos.</p>
        <div className="transition-actions">
          <button className="phase-submit-btn" onClick={() => { close(); onArchive?.(); }}>Ver Quiniela RH</button>
